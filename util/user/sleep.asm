...
int main(int argn, char *argv[]){
  ...
  1e:	602080e7          	jalr	1538(ra) # 61c <fprintf>
		exit(1);
  22:	4505                	li	a0,1
  24:	00000097          	auipc	ra,0x0
  28:	2ae080e7          	jalr	686(ra) # 2d2 <exit>
	}
  ...
  3c:	7e050513          	addi	a0,a0,2016 # 818 <malloc+0x110>
  40:	00000097          	auipc	ra,0x0
  44:	60a080e7          	jalr	1546(ra) # 64a <printf>
	sleep(sleep_time);
  48:	8526                	mv	a0,s1
  4a:	00000097          	auipc	ra,0x0
  4e:	318080e7          	jalr	792(ra) # 362 <sleep>
	exit(0);
  52:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	49250513          	addi	a0,a0,1170 # 848 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c6:	27e90913          	addi	s2,s2,638 # 840 <malloc+0x138>
        while(*s != 0){
 ...
 6bc:	00e6ea63          	bltu	a3,a4,6d0 <free+0x50>
{
 ...
 6fe:	16f73323          	sd	a5,358(a4) # 860 <freep>
}
 702:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 730:	13453503          	ld	a0,308(a0) # 860 <freep>
 ...
 758:	10c90913          	addi	s2,s2,268 # 860 <freep>
  if(p == (char*)-1)
 75c:	5afd                	li	s5,-1
 75e:	a88d                	j	7d0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 760:	00000797          	auipc	a5,0x0
 764:	10878793          	addi	a5,a5,264 # 868 <base>
 768:	00000717          	auipc	a4,0x0
 76c:	0ef73c23          	sd	a5,248(a4) # 860 <freep>
 770:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 792:	0ca73923          	sd	a0,210(a4) # 860 <freep>
      return (void*)(p + 1);
